...
# --- 引用检查报告 (V4.1 Final: Two-way Report with Proper Warnings) ---
            if check_citations_opt:
                ...
                # --- 头部关键提示 (根据排序选项动态变化) ---
                if sort_references:
                    report_content += "⚠️ [ACTION REQUIRED] Auto-sort is ON.\n"
                    report_content += "   ITALICS in the Reference List have been REMOVED by the sorting process.\n"
                    report_content += "   Please re-apply italics to journal/book titles manually.\n\n"
                else:
                    report_content += "ℹ️ [INFO] Auto-sort is OFF.\n"
                    report_content += "   References order is kept as original. Please ensure they are alphabetical.\n\n"
                ...
                if missing_in_refs:
                    ...
                    report_content += "(Please verify spelling, year, or 'et al.' usage)\n"
                    report_content += "-" * 30 + "\n"
                ...
                if missing_in_body:
                    ...
                    report_content += "(Did you forget to cite these? or is it a typo?)\n"
                    report_content += "-" * 30 + "\n"
                ...
                report_content += "\n" + "=" * 40 + "\n"
                report_content += "*Report generated by APA 7th Format Assistant*"
